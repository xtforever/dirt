/* SCCSID: @(#)CommandI.h	1.1 (UKC) 5/10/92 */
...
/*
 *
 *  A few definitions to make Xukc/Command.c easier to read.
 *   
 */
...
#define ComWhighlightGC			 cbw->command.highlight_border_GC
#define ComWhighlightColor		 cbw->command.highlight_color
#define ComWhighlightRegion		 cbw->command.highlight_region
...
#define ComWsetRegion                    cbw->command.set_region
